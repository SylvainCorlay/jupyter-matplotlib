...
var MPLCanvasView = widgets.DOMWidgetView.extend({
    ...
    update_toolbar_position: function() {
        ...
        if (toolbar_position == 'top' || toolbar_position == 'bottom') {
            this.el.classList = 'jupyter-widgets widget-container widget-box widget-vbox jupyter-matplotlib-widget';
            ...
            this.el.classList = 'jupyter-widgets widget-container widget-box widget-hbox jupyter-matplotlib-widget';
